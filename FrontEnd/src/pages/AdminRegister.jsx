    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <div className="p-10 shadow-2xl shadow-black rounded-3xl bg-[#88baa6] border-2 border-gray-500 font-sans max-w-sm w-96">
                <h1 className="text-4xl text-center mb-6 font-bold text-black">Admin Register</h1>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="text-center">
                        <span className="text-md text-gray-800">
                            Already have an account? <Link to="/adminLogin" className="text-black hover:underline">Sign In</Link>
                        </span>
                    </div>
                </form>
            </div>
